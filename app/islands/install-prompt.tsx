  ...
  if (mode === "settings") {
    return (
      <section aria-labelledby="install-heading" className="space-y-4">
        ...
        <div className="alert alert-info alert-soft alert-vertical items-center text-base-content sm:alert-horizontal">
          <PhosphorIcon
  ...
  return (
    <div className="pointer-events-none fixed inset-x-4 bottom-4 z-20 sm:inset-x-6">
      <div className="pointer-events-auto mx-auto max-w-5xl">
        <div className="alert alert-info alert-soft alert-vertical border-base-300 text-base-content shadow-lg sm:alert-horizontal">
          <PhosphorIcon
            className="inline-flex shrink-0 text-info [&_svg]:size-6"
            svg={infoIcon}
          />
